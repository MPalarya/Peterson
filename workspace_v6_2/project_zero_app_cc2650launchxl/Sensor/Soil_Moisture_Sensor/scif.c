...
static const uint16_t pAuxRamImage[] = {
    ...
    /*0x00C0*/ 0x6436, 0xBDB7, 0x241A, 0xA6FE, 0xADB7, 0x641A, 0xADB7, 0x0000, 0x007E, 0x0083, 0x00C6, 0x0000, 0x0000, 0xFFFF, 0x0000, 0x0000, 
    /*0x00E0*/ 0x0000, 0x0000, 0x0000, 0x0000, 0x0032, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0001, 0x7005, 0x14C7, 
    /*0x0100*/ 0x0001, 0x0C67, 0xADB7, 0x740E, 0x70BC, 0x6007, 0x14D4, 0x705D, 0x6003, 0x14D4, 0x7041, 0x1462, 0xFB4D, 0x8609, 0x7101, 0x6431, 
    /*0x0120*/ 0x2531, 0xA6FE, 0xFB00, 0x7018, 0xFB4C, 0x7003, 0xFB4C, 0xFD47, 0xFB4C, 0x1465, 0x6403, 0x001F, 0x8B2C, 0xFDB1, 0x9902, 0x1C7C, 
    /*0x0140*/ 0x14DA, 0x540E, 0x787B, 0x0075, 0x8D27, 0xAF10, 0x3874, 0xAD1B, 0xBF10, 0x0874, 0xBD20, 0x087D, 0x9D2A, 0xE601, 0x0001, 0x9D2B, 
    /*0x0160*/ 0xFE01, 0x0001, 0x8A01, 0xBE0F, 0x0000, 0x2075, 0xAF1A, 0x9D2A, 0xEE01, 0xFD40, 0x8801, 0x8A05, 0xAEF8, 0x7C7B, 0x0000, 0x0C7D, 
    /*0x0180*/ 0x086C, 0x8201, 0x0C6C, 0x0001, 0x0C67, 0xADB7, 0xADB7, 0xF007, 0x1462, 0x86FF, 0x63F8, 0xEB51, 0x8680, 0x6000, 0xED8F, 0xEB49, 
    /*0x01A0*/ 0xFD47, 0xEB49, 0x1465, 0xADB7, 0xFB0C, 0xEDA4, 0xEB09, 0x640B, 0xCDB1, 0xADB7, 0x1462, 0x7079, 0xFB55, 0x71FB, 0xFB54, 0xFD47, 
    /*0x01C0*/ 0xFB54, 0x1465, 0x4431, 0x4400, 0xADB7
};
...
//  cfg         input       output      state       
    0x007010E8, 0x00000000, 0x001010F6, 0x002010F8  // Soil Moisture Sensor
};
...
void scifReinitTaskIo(uint32_t bvTaskIds) {
    if (bvTaskIds & (1 << SCIF_SOIL_MOISTURE_SENSOR_TASK_ID)) {
        scifReinitIo(5, -1);
        scifReinitIo(4, -1);
    }
} // scifReinitTaskIo
